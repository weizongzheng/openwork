...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/static/css/orgFace.css">
    ...
    <script  src="${pageContext.request.contextPath}/static/js/orgFacejs.js"></script>
    <style type="text/css">
        tr{
            margin: 0;
            padding: 0;
...
<div class="form_2" >
    <form method="post" action="">
        <div class="input_1"><div class="login_logo">组织详情信息</div><div class="close1" onclick="closeIt()">X</div></div>
        <hr>
        <div class="span2" >组织ID：<span id="org_id"></span></div>
        <div class="span2" >组织名称：<span id="org_name"></span></div>
        ...
        <div class="input_1"><input class="submit_1 inputd" type="button" value="退出&nbsp;组织" onclick="exitOrg()"></div>
    </form>
</div>
    ...
    <div class="row clearfix" style="margin: 0;padding: 0">
        ...
        <button  class="span" style="margin-left: 20px; font-weight: bolder" onclick="search()">搜索组织</button> &nbsp;<input id="searchOrg" type="text"/>
        &nbsp;&nbsp;&nbsp;&nbsp;
        <button class="span" style="font-weight: bolder" id="btn_1" onclick="addorg()">添加组织</button>&nbsp;<input id="addOrg" type="text"/>
            <br>
